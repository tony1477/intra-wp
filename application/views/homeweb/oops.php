...
<section class="bg-servicesstyle2-section">
    ...
    <div class="section-header text-left">
        ...
        <p class="alert alert-success">Oops... Halaman tidak ditemukan.<br><br> <a href="<?php echo base_url() ?>" class="btn btn-warning"><i class="fa fa-home"></i> Kembali ke Beranda</a></p>
    </div>
