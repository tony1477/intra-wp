  ...
  echo "<div class='col-xs-12'>
          <div class='box box-info box-solid' style='margin: -20px -5px 15px 1px;'>
            <div class='box-header'>
              <h3 class='box-title'><span class='glyphicon glyphicon-new-window'></span> Insert Data Group Divisi</h3>
            </div>

            <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form','onsubmit'=>'return ifcekemptytext()','action'=>'<?php echo base_url()');
              echo form_open_multipart('modul_tbl/ifmdivisigroupcs/tbl_ifmdivisigroupcs/ifinsertrecord', $attributes);
              echo "<div class='col-md-12'>
                <table class='table table-condensed table-bordered'>
                    <tbody>
                        <input type='hidden' name='id' value=''>
                        <tr><th width='130px' scope='row'>Kode Divisi</th><td><input type='text' id='txtkode' maxlength='3' class='form-control' name='txtkode' onkeyup='this.value = this.value.toUpperCase()' autofocus></td></tr> 
          ...
          <div class='box-footer'>
              ...
              <a href='".base_url().$this->uri->segment(1)."/ifmdivisigroupcs/tbl_ifmdivisigroupcs/ifshowtbldivisigroup'><button type='button' class='btn btn-primary pull-right' data-toggle='tooltip' data-placement='bottom' title='Kembali'><i class='glyphicon glyphicon-log-out'></i> Tutup</button></a>
          </div>
        </div></form>";
?>
...
<script type="text/javascript">
	function ifcekemptytext() {
		  ...
		  if (!$("#txtnama").val()) {
			    alert('Mohon mengisi nama divisi (Indonesia)');
			    $("#txtnama").focus()
			    return false;
		  }
	}
