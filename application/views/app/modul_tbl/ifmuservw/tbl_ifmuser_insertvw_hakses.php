              ...
              echo "<div class='col-md-12'>
                <table class='table table-condensed table-bordered'>
                    <tbody>
                        ...
                        <tr><th scope='row'>Akses Modul</th><td><input type='checkbox' id='mstcheckbox' name='mstcheckbox'><strong> Pilih Semua Modul </strong><br><div class='checkbox-scroll'>"
                        foreach ($armodul as $rows) {
                          echo "<span style='display:block'>&emsp;&ensp;&nbsp;<input name='chkmodul[]' type='checkbox' value='$rows[dok_nosop]' /> $rows[dok_nosop] - $rows[dok_nmsop] ($rows[dep_kode])</span> ";
                        }
                        echo "</div></td></tr>
