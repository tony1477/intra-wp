...
<html>
  <head>
    ...
    <!-- Konfigugasi javascript pdfobject -->
    <!-- konfigurasi ini digunakan untuk mengatur tampilan pdf di browser mozilla --> 
    <!-- <script src="<?php echo base_url(''); ?>ifassetadm/pdfobject/pdfobject.js"></script> -->
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
          <?php
            ...
            if ($this->session->div_kode == 'HO') { 
                include "menu-bpo-ho.php";
            } elseif (($this->session->div_kode == 'PKS')) {
                include "menu-bpo-pks.php";
            } elseif (($this->session->div_kode == 'EST')) {
                include "menu-bpo-est.php";
            } else {
                include "menu-bpo-ho.php";
            }
