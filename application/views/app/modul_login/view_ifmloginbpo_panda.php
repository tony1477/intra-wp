  ...
  <body class="hold-transition login-page">
    ...
    <form action="" method="post">
      ...
      <div class="form-group">
        <input type="text" name='txtuserkode' required="required" class="form-control"/>
        <label class="form-label">Kode User</label>
      </div>

      <div class="form-group">
        <input id="password" type="password" name='txtuserpwd' required="required" class="form-control"/>
